...
def _make_mock_result(filename, score=75, risk_level="低"):
    return {
        ...
        "evaluation": {
            ...
            "credibility": {"score": score - 5, "observations": ["テスト"], "confidence": "中"},
            "professional_demeanor": {"score": score - 2, "observations": ["テスト"], "confidence": "中"},
        },
    ...
    def test_process_single_video(self, tmp_path):
        ...
        mock_analyzer.analyze.return_value = {
            ...
            "evaluation": {
                ...
                "professional_demeanor": {"score": 75, "observations": [], "confidence": "中"},
            },
            "behavioral_metrics": None,
            "red_flags": [],
            "positive_signals": [],
